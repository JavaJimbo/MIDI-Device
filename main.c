...
void BlinkUSBStatus(void)
{
    ...
    static short displayCounter = 10;
    ...
    if(led_count == 0){
        ...
        //if (!displayCounter){
        //    displayCounter = 10;
        //    printf("\rblinkCounter: %d", blinkCounter++);  // $$$$
        //}
    }
    led_count--;
...
void ProcessIO(void)
{
    static unsigned long ADcounter = 10000;
    ...
    */
    ...
    if(!USBHandleBusy(USBRxHandle))
    {
        ...
        USBRxHandle = USBRxOnePacket(MIDI_EP,(BYTE*)&ReceivedDataBuffer,64);
        length = USBHandleGetLength(USBRxHandle);
        printf("\rLEN: %d: %X, %X, %X", length, ReceivedDataBuffer[0], ReceivedDataBuffer[1], ReceivedDataBuffer[2]);
    }
